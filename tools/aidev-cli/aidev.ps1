...
#
# 使い方:
#   pwsh tools/aidev-cli/aidev.ps1 new <slug> [--mode interactive|autonomous] [--ticket ID] [--depends a,b,#N] [--parent <親work>]
#     --parent 指定時は親 work 配下に subtask（<NN>-<subslug>・date prefix なし・current=plan）を作る
#   pwsh tools/aidev-cli/aidev.ps1 event <phase> <start|approved|sent_back> [key=value ...]
#   pwsh tools/aidev-cli/aidev.ps1 approve <phase> [key=value ...]
#   pwsh tools/aidev-cli/aidev.ps1 guard <phase>
#   pwsh tools/aidev-cli/aidev.ps1 verify [slug]
#   pwsh tools/aidev-cli/aidev.ps1 doctor
#   pwsh tools/aidev-cli/aidev.ps1 status [--format table|tsv]
#   pwsh tools/aidev-cli/aidev.ps1 metrics [slug] [--all] [--phases] [--format table|tsv]
#   pwsh tools/aidev-cli/aidev.ps1 worktree add <slug> [--branch n] [--base ref] [--path dir] [--mode m] [--ticket id] [--depends list]
#   pwsh tools/aidev-cli/aidev.ps1 worktree list [--format table|tsv]
#   pwsh tools/aidev-cli/aidev.ps1 worktree rm <slug|path> [--force] [--delete-branch]
#   pwsh tools/aidev-cli/aidev.ps1 help
#
